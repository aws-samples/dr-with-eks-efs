...
> **_NOTE:_** EKS cluster creation process completes in about 15 minutes. You can either wait or you can open a separate terminal window and move on to the next step to deploy the infrastructure in the DR region.
