...
export EnvironmentNamePrimary=$(aws cloudformation describe-stacks --stack-name $CFNstack --query "Stacks[0].Parameters[?ParameterKey == 'EnvironmentName'].ParameterValue" --output text --region $AWS_REGION_PRIMARY)
